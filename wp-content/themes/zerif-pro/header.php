						...
						<?php
							...
							if( !empty($zerif_logo) ):
								...
								echo '<a href="'.esc_url( home_url( '/' ) ).'" class="navbar-brand">';
									...
									echo '<img class="hidden-xs" src="'.$zerif_logo.'" alt="'.get_bloginfo('title').'">';

									echo '<img class="hidden-lg hidden-md hidden-sm" width="270px" src="'.$zerif_logo.'" alt="'.get_bloginfo('title').'">';
