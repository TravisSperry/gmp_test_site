<?php
	...
	if( !empty($zerif_total_posts) && ($zerif_total_posts > 0) ):
		...
		if( !empty($zerif_latest_news_show) ):
			...
			echo '<div style="background:white;color:#393939;"><hr style="color:#393939;margin:0;"></div>';
		...
		if( !empty($zerif_latest_news_show) || isset( $wp_customize ) ):
			...
			echo '<a href="#subscribe"><i class="fa fa-3x fa-chevron-down" style="color:#383838; margin-top:10px;"></i></a>';
